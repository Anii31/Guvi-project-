const cars = [
    ...
    },
    {
        ...
        features: ["AC", "CVT", "4 Seats", "USB Ports"]
    },
    {
        id: 3,
        ...
        features: ["AC", "Automatic", "7 Seats", "AWD", "Roof Rails"]
    },
    {
        id: 4,
        model: "Audi A4",
        ...
        features: ["AC", "Automatic", "5 Seats", "Leather", "Navigation", "Sunroof"]
    },
    {
        id: 5,
        model: "GMC Yukon",
        ...
        features: ["AC", "Automatic", "8 Seats", "4WD", "Towing Package"]
    },
    {
        id: 6,
        model: "Lexus ES",
        ...
        features: ["AC", "Automatic", "5 Seats", "Leather", "Premium Audio", "Heated Seats"]
    }
];
    ...
    carsToShow.forEach(car => {
        ...
        carCard.innerHTML = `
            <div class="car-image-container">
                <img src="${car.image}" alt="${car.model}" class="car-image" onerror="this.src='https://via.placeholder.com/300x200/28a745/ffffff?text=Vehicle+Image'">
            </div>
            <div class="car-info">
                <h3>${car.model}</h3>
            <p class="price">$${car.pricePerDay}/day</p>
            <p><strong>Type:</strong> ${car.type.charAt(0).toUpperCase() + car.type.slice(1)}</p>
...
function openBookingModal(carId) {
    ...
    document.getElementById('selected-car-info').innerHTML = `
        <div style="text-align: center; margin-bottom: 20px;">
            <img src="${selectedCar.image}" alt="${selectedCar.model}" style="width: 100%; max-width: 300px; height: 200px; object-fit: cover; border-radius: 10px; margin-bottom: 15px;" onerror="this.src='https://via.placeholder.com/300x200/28a745/ffffff?text=Vehicle+Image'">
            <h3>${selectedCar.model}</h3>
            <p style="font-size: 1.2em; color: #28a745; font-weight: bold;">$${selectedCar.pricePerDay}/day</p>
        </div>
    `;
...
function loadBookings() {
    ...
    if (!emailRegex.test(email)) {
        showEmailError('Please enter a valid email address (must contain @ and domain like .com, .org, etc.)');
        return;
    }
